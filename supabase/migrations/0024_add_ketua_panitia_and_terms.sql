...
-- "Terms" (payment method: Cash or Cheque) to the New Order form.
...
alter table public.orders add constraint orders_terms_check check (terms is null or terms in ('Cash', 'Cheque'));
